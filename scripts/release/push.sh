...
docker push "registry.github.com/pepeunlimited/go-github-starter-kit:$VERSION_SLUG"
docker push "registry.github.com/pepeunlimited/go-github-starter-kit:latest"